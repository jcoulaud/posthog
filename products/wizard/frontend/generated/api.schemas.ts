...
export interface PaginatedRepositoryDetectionDTOListApi {
    count: number
    /** @nullable */
    next?: string | null
    /** @nullable */
    previous?: string | null
    results: RepositoryDetectionDTOApi[]
}
...
export type WizardRepositoryDetectionsListParams = {
    /**
     * Filter to a single detection kind (e.g. 'error-tracking-source-maps').
     */
    kind?: string
    /**
    ...
    offset?: number
    /**
     * Filter to a single repository ('org/repo').
     */
    repository?: string
}
